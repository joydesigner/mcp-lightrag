...
The WORKING_DIR path is TEST-MCP
...
async def main_async():
    try:
        ...
        if not os.path.exists("./book.txt"):
            print("Error: book.txt not found in the current directory")
            return

        print("Processing book.txt...")
        ...
        # Example queries
        queries = [
            ("What is Prompt Formula?", "naive"),
            ("What is the Seed-Word?", "local"),
            ("What is the Seed-Word Prompt?", "global"),
            ("What is the Knowledge Integration Prompt?", "hybrid")
        ]
...
API Response:
"Hello! How can I assist you today? I'm here and ready to help. Feel free to ask me anything you need!"

API test successful!
INFO: Process 75374 Shared-Data created for Single Process
...
INFO: Process 75374 initialized updated flags for namespace: [full_docs]
INFO: Process 75374 ready to initialize storage namespace: [full_docs]
INFO: Process 75374 initialized updated flags for namespace: [text_chunks]
INFO: Process 75374 ready to initialize storage namespace: [text_chunks]
INFO: Process 75374 initialized updated flags for namespace: [entities]
INFO: Process 75374 initialized updated flags for namespace: [relationships]
INFO: Process 75374 initialized updated flags for namespace: [chunks]
INFO: Process 75374 initialized updated flags for namespace: [chunk_entity_relation]
INFO: Process 75374 initialized updated flags for namespace: [llm_response_cache]
INFO: Process 75374 ready to initialize storage namespace: [llm_response_cache]
INFO: Process 75374 initialized updated flags for namespace: [doc_status]
INFO: Process 75374 ready to initialize storage namespace: [doc_status]
INFO: Process 75374 storage namespace already initialized: [full_docs]
INFO: Process 75374 storage namespace already initialized: [text_chunks]
INFO: Process 75374 storage namespace already initialized: [llm_response_cache]
INFO: Process 75374 storage namespace already initialized: [doc_status]
INFO: Process 75374 Pipeline namespace initialized
Processing book.txt...
Read 48772 characters from book.txt
...
Query: What is Prompt Formula?
Mode: naive
Processing query in naive mode...
Response: ### What is Prompt Formula?

A **Prompt Formula** is a structured way to instruct a language model like ChatGPT on how to generate text that meets specific requirements. It allows users to control the output by providing clear instructions, tasks, and roles for the model to follow. The formula typically includes three main components:

1. **Task**: A clear and concise statement of what the model is supposed to generate.
2. **Instructions**: The specific guidelines or rules that the model should follow when generating the text.
3. **Role**: The role or perspective from which the model should generate the text.

For example, a prompt formula for generating a summary might look like this:

**"Summarize the following news article in one short sentence: [insert article]"**

This formula tells the model to generate a concise summary of the article while adhering to the specified format.

### Examples of Prompt Formulas
...
- [KG] Chapter 1: Introduction to Prompt Engineering Techniques - [File: document_chunks/chapter_1.pdf]
- [KG] Chapter 2: Instructions Prompt Technique Examples - [File: document_chunks/chapter_2.pdf]
- [KG] Chapter 16: Dialogue prompts - [File: document_chunks/chapter_16.pdf]
- [KG] Chapter 17: Adversarial prompts - [File: document_chunks/chapter_17.pdf]
- [KG] Chapter 18: Clustering prompts - [File: document_chunks/chapter_18.pdf]

Query: What is the Seed-Word?
Mode: local
Processing query in local mode...
Response: ### Seed-Word

A **seed-word** is a technique used in prompt engineering to generate text related to a specific word or phrase. It involves creating a prompt formula that includes the seed word or phrase followed by a command to generate text based on it. This method allows models like ChatGPT to create new and original information or text related to the seed word.

For example, the prompt formula for a seed-word prompt might look like this:

```
"Please generate text based on the following seed-word: [seed-word]"
```

This technique is widely used in tasks such as text generation, summarization, and creative writing. It provides a structured way to guide the model to produce content that is related to the seed word or phrase provided.

### References

[KG] Source content (File: sources.csv)  
"Seed-Word prompt is a technique used to generate text related to a specific seed-word or phrase."

Query: What is the Seed-Word Prompt?
Mode: global
Processing query in global mode...
Response: ### Seed-Word Prompt

A Seed-Word Prompt is a technique used to guide the output of a model by providing specific terms or concepts that highlight key aspects or features of the desired content. This method is particularly useful for tasks that require emphasizing certain characteristics or for generating content that aligns with specific themes.

#### How it works:
1. **Definition**: A seed word is a specific term or concept that is used to guide the model's output. By incorporating seed words into the prompt, the model is instructed to focus on certain aspects of the topic.
2. **Usage**: Seed words are often used in conjunction with other prompting techniques, such as role prompting or standard prompts, to further refine the output.
3. **Examples**:
   - **Product Description**: "The product has a seed word of 'innovative,' so the description should highlight its innovative features."
   - **Legal Document**: "The document should focus on the seed word 'privacy,' ensuring that all privacy-related clauses are clearly addressed."

#### Application:
- **Product Descriptions**: Seed words can be used to emphasize specific features or benefits of a product.
- **Legal Documents**: Seed words help in focusing on critical aspects of the document, such as compliance with regulations.
- **Customer Service Responses**: Seed words can guide responses to be more empathetic or solution-focused.

#### References:
1. [Seed-Word Prompting] Source content (File: kg-2023-04-20-123456789012.csv)
...
Query: What is the Knowledge Integration Prompt?
Mode: hybrid
Processing query in hybrid mode...
Response: ### Knowledge Integration Prompt

**Definition:** Knowledge Integration Prompts are a technique used in language models like ChatGPT to combine new information with existing knowledge to generate more comprehensive and accurate outputs. This method allows the model to leverage its pre-existing knowledge base while incorporating new data or insights to produce more insightful and relevant text.

**How it works:** When using a Knowledge Integration Prompt, the model is provided with a specific task or question and a set of predefined options or pieces of new information. The prompt instructs the model to integrate this new information with its existing knowledge to generate a response that is both relevant to the task and consistent with the provided context.

**Examples:**

1. **Integrating new data with existing knowledge:**  
   "Integrate the following new information about [specific topic] with the existing knowledge about [specific topic]. Generate a concise summary that connects both pieces of information."

2. **Updating existing knowledge with new information:**  
   "Update the existing knowledge about [specific topic] with the following new information. Provide a detailed explanation that incorporates both old and new knowledge."

3. **Connecting different pieces of information:**  
   "Connect the following pieces of information in a way that is relevant and logical. The information pertains to [specific topic]."

**Use Cases:**  
Knowledge Integration Prompts are particularly useful for tasks such as data analysis, research, and knowledge updating. For example, a researcher could use this technique to analyze trends in a field by integrating new data with existing studies. Similarly, a student could use it to synthesize information from multiple sources to better understand a subject.

**References:**  
- [Knowledge Integration](https://knowledge-base.org/knowledge/integration/knowledge-integration-prompts)  
- [Seed-word prompt](https://knowledge-base.org/knowledge/generate/seed-word-prompt)  
- [Knowledge Generation](https://knowledge-base.org/knowledge/generate/knowledge-generation-prompts)  

These examples and explanations demonstrate how Knowledge Integration Prompts can enhance the capabilities of language models by combining new information with existing knowledge to produce more meaningful and accurate outputs.
```
...
Ref URL: https://modelcontextprotocol.io/llms-full.txt
